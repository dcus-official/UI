--[[
	 ...
	 __  __ _       _        _                    __     ______         ___        _ 
	|  \/  (_)_ __ | |_ _ __(_)_ __   ___   __ _  \ \   / /___ \       / _ \      / |
	| |\/| | | '_ \| __| '__| | '_ \ / _ \ / _` |  \ \ / /  __) |     | | | |     | |
	| |  | | | | | | |_| |  | | | | | (_) | (_| |   \ V /  / __/   _  | |_| |  _  | |
	|_|  |_|_|_| |_|\__|_|  |_|_| |_|\___/ \__,_|    \_/  |_____| (_)  \___/  (_) |_|

    OBS System by @.dcus -- Object Bypassing System
    
    Original: LinoriaUI -- https://github.com/violin-suzutsuki/LinoriaLib
    
    Copyright (c) 2026 @.dcus. All rights reserved.
    No Modification or Distribution without written permission.
    
    This system is designed to create and manage UI elements dynamically.
    It uses a unique naming system and supports various UI types.
    ...
    Usage Instructions:
    - Use the provided functions to create and manage UI elements.
    - Ensure you have the latest version of the system.
...
local BaseURL = "https://raw.githubusercontent.com/mstudio45/MintrinoaLib/refs/heads/main/"
local CustomImageManager = {}
local CustomImageManagerAssets = {
	Cursor = {
		RobloxId = 9619665977,
		Path = "MintrinoaLib/assets/Cursor.png",
	...
	DropdownArrow = {
		RobloxId = 6282522798,
		Path = "MintrinoaLib/assets/DropdownArrow.png",
	...
	Checker = {
		...
		Path = "MintrinoaLib/assets/Checker.png",
	...
	CheckerLong = {
		...
		Path = "MintrinoaLib/assets/CheckerLong.png",
	...
	SaturationMap = {
		RobloxId = 4155801252,
		Path = "MintrinoaLib/assets/SaturationMap.png",
...
local BlurEffect = game:GetService("Lighting"):FindFirstChild("MintrinoaBlur") or Instance.new("BlurEffect")
BlurEffect.Name = "MintrinoaBlur"
BlurEffect.Size = 0
...
_L.Modules["SaveManager"] = (function()
	...
	local SaveManager = {} do
		SaveManager.Folder = "MintrinoaLibSettings"
...
_L.Modules["ThemeManager"] = (function()
	...
	local ThemeManager = {} do
		...
		ThemeManager.Folder = "MintrinoaLibSettings"
